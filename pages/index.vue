<template>
    <div class="w-full h-screen p-4 text-center bg-white rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Welcome to our page</h5>
        ...
        <button @click="counter.increment()">Count: {{ counter.count }} - {{ counter.doubleCount }}</button>
    </div>
</template>
